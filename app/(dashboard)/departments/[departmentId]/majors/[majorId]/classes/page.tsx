...
export default function ClassesPage({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mb-4">
        <Link href={`/departments/${params.departmentId}/majors`}>
          ...
          <Card key={classItem.id} className="hover:bg-gray-50">
            <CardContent className="p-4">
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  <div className="font-medium">Class code: {classItem.classCode}</div>
                </div>
                <div className="text-sm text-muted-foreground">Degree: {classItem.degree}</div>
                <div className="text-sm text-muted-foreground">Year level: {classItem.yearLevel}</div>
