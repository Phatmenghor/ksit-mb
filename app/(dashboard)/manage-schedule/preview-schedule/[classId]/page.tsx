  ...
  return (
    <div>
          ...
          <Card>
            <CardContent className="flex justify-end items-center p-4 gap-3">
              ...
              <Button
                ...
                className="bg-green-900 hover:bg-green-950 text-white px-6"
              >
                {isSubmitting ? (
                  <>
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to confirm this duplicate schedule? This action cannot be undone."
        onConfirm={() => {
