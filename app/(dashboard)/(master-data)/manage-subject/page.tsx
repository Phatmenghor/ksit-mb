...
import {
    RoomFormData as SubjectFormData,
...
import { AllSubjectModel, SubjectModel } from "@/model/master-data/subject/all-subject-model";
import { AllSubjectFilterModel } from "@/model/master-data/subject/type-subject-mode";
import { createSubjectService, deletedSubjectService, getAllSubjectService, updateSubjectService } from "@/service/master-data/subject.service";
...
export default function ManageRSubjectPage() {
    ...
    const [allSubjectData, setAllSubjectData] = useState<AllSubjectModel | null>(null);
